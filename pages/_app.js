              ...
              return (
                ...
                >
                  ...
                  <div>
                    ...
                    {mode === 'v'
                      ? <div style={{ writingMode: 'vertical-rl', fontSize: isMobile ? 11 : 13, fontWeight: fp.fw, color: tc, fontFamily: fp.f, lineHeight: `${w - 4}px`, overflow: 'hidden', height: spineH - 32 }}>{b.title}</div>
                      : <div style={{ fontSize: isMobile ? 9 : 11, fontWeight: fp.fw, color: tc, fontFamily: fp.f, lineHeight: 1.35, wordBreak: 'keep-all', overflow: 'hidden', maxHeight: spineH - 32 }}>{b.title}</div>
                    }
                  </div>
                </div>
              )
