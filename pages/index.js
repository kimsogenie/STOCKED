...
export default function Home() {
  ...
  // 이번 주 인기 책 — 수동 업데이트
  const POPULAR_UPDATED = '2026.7.20'
  const POPULAR_BOOKS = [
    { rank: 1, title: '대멸종', author: '시아란, 심너울, 범유진 외' },
    { rank: 2, title: '레슨 인 케미스트리 1', author: '보니 가머스' },
    { rank: 3, title: '70세 사망법안, 가결', author: '가키야 미우' },
  ]
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '48px 32px 40px' }}>
          <div style={{ marginBottom: 28 }}>
            ...
            <div style={{ fontSize: 12, color: C.muted, fontFamily: C.font, lineHeight: 1.7 }}>
              책 한 권 한 권을 기록하고,<br />기억하고 싶은 문장을 영수증으로 저장하세요.
            </div>
          </div>
  ...
  if (view === 'wishlist') {
    ...
    const slots = [
      { top: 44, left: 32,  rot: -12, size: 58, z: 4 },
      { top: 42, left: 46,  rot: 8,   size: 56, z: 4 },
      { top: 45, left: 58,  rot: -6,  size: 56, z: 4 },
      { top: 56, left: 30,  rot: 10,  size: 54, z: 3 },
      { top: 54, left: 45,  rot: -5,  size: 56, z: 3 },
      { top: 57, left: 58,  rot: 9,   size: 52, z: 3 },
      { top: 68, left: 33,  rot: -9,  size: 50, z: 2 },
      { top: 66, left: 47,  rot: 7,   size: 48, z: 2 },
      { top: 69, left: 59,  rot: -7,  size: 50, z: 2 },
      { top: 50, left: 38,  rot: 11,  size: 48, z: 3 },
      { top: 62, left: 52,  rot: -8,  size: 46, z: 2 },
      { top: 72, left: 44,  rot: 6,   size: 44, z: 1 },
    ]
